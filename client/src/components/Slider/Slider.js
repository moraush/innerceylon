  ...
  <div className="container-dots">
      {post.selectedFile.map((item, index) =>(
          ...
          "dot"}>
              ...
              <img className='dot-image' src={item}  alt="https://www.gannett-cdn.com/-mm-/05e97d16e7fb53439a4222e53dcba47d4d31dde8/c=0-97-1280-584/local/-/media/USATODAY/USATODAY/2014/06/04/1401911998000-AP-Color-Cosmos.jpg?width=3200&height=1680&fit=crop" />
...
export default Slider
  ...
  {/* <div className="container-dots">
      {Array.from({length:post.selectedFile.length}).map((item, index) =>(
          <div 
          onClick={() => moveDot(index+1)}
          className={slideIndex === index +1 ?"dot active" :
          "dot"}>
